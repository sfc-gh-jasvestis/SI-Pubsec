...
-- Note: Semantic models are YAML files in stages, not database objects requiring CREATE privileges
-- The role already has ALL privileges on SNOWFLAKE_PUBSEC_DEMO.SEMANTIC_MODELS schema
