...
-- Grant Snowflake Intelligence specific privileges on schema (not account)
GRANT CREATE AGENT ON SCHEMA SG_PUBSEC_DEMO.INTELLIGENCE TO ROLE SG_INTELLIGENCE_ADMIN;
GRANT CREATE CORTEX SEARCH SERVICE ON SCHEMA SG_PUBSEC_DEMO.INTELLIGENCE TO ROLE SG_INTELLIGENCE_ADMIN;
